-- Riwayat transaksi/struk dipisahkan dari laporan keuangan lengkap.
...
alter table public.profiles
  add constraint profiles_custom_permissions_allowed check (
    custom_permissions is null or custom_permissions <@ array[
      ...
      'report.view','audit.view','workforce.self','workforce.manage',
      'approval.manage','multioutlet.view','multioutlet.manage','sale.adjust','sale.void'
    ]::text[]
  );
