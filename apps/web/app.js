...
function receiptPromotionLabel(promotion){
  return `Promo ${String(promotion.code??'PROMO')}: −${money.format(Math.abs(Number(promotion.discount??0)))}`;
}
