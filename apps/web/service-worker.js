const CACHE = 'nusa-pos-shell-v234';
...
const SHELL = ['/', '/styles.css?v=222', '/app.js?v=225', '/restock-draft.mjs', '/restock-inspection.mjs', '/product-categories.mjs', '/manifest.webmanifest'];
