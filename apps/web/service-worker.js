const CACHE = 'nusa-pos-shell-v235';
...
const SHELL = ['/', '/styles.css?v=222', '/app.js?v=226', '/restock-draft.mjs', '/restock-inspection.mjs', '/product-categories.mjs', '/manifest.webmanifest'];
