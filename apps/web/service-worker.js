const CACHE = 'nusa-pos-shell-v236';
...
const SHELL = ['/', '/styles.css?v=222', '/app.js?v=227', '/restock-draft.mjs', '/restock-inspection.mjs', '/product-categories.mjs', '/manifest.webmanifest'];
