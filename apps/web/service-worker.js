const CACHE = 'nusa-pos-shell-v233';
...
const SHELL = ['/', '/styles.css?v=222', '/app.js?v=224', '/restock-draft.mjs', '/restock-inspection.mjs', '/product-categories.mjs', '/manifest.webmanifest'];
