...
export const ROLE_PERMISSIONS = Object.freeze({
  ...
  ADMIN: [PERMISSIONS.POS_SELL, PERMISSIONS.PROCESS_RETURN, PERMISSIONS.MANAGE_INVENTORY, PERMISSIONS.MANAGE_PRODUCTS, PERMISSIONS.MANAGE_PROMOTIONS, PERMISSIONS.VIEW_REPORTS, PERMISSIONS.VIEW_AUDIT]
});
