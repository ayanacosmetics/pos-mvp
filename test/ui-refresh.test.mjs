...
test('Nusa Commerce memakai identitas rilis dan aset shell terbaru', () => {
  ...
  assert.match(html, /styles\.css\?v=217/);
  assert.match(html, /app\.js\?v=220/);
  assert.match(worker, /nusa-pos-shell-v228/);
  assert.match(worker, /styles\.css\?v=217/);
  assert.match(worker, /app\.js\?v=220/);
