...
test('Nusa Commerce memakai identitas rilis dan aset shell terbaru', () => {
  ...
  assert.match(html, /styles\.css\?v=221/);
  assert.match(html, /app\.js\?v=223/);
  assert.match(worker, /nusa-pos-shell-v232/);
  assert.match(worker, /styles\.css\?v=221/);
  assert.match(worker, /app\.js\?v=223/);
