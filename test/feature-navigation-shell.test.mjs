...
test('fitur gabungan dipisahkan menjadi tujuan halaman sendiri', async () => {
  ...
  for (const view of ['summary','performance','purchases','purchases-history','sales','sales-products','sales-categories','sales-addons','stock-flow','audit']) assert.match(html, new RegExp(`data-report-view="${view}"`));
